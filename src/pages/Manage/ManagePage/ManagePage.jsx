...
import { ClipboardCheckIcon, ClipboardListIcon, DumbbellIcon, LinkCard, FileLinesIcon, UserIcon, GraduationCapIcon } from '@/components';
...
const ManagePage = () => {
  ...
  return (
    <div className={styles.ManagePage}>
      ...
      <LinkCard
        text={t('Manage Courses')}
        to={{ pathname: '/manage/courses' }}
        renderIcon={(props) => <GraduationCapIcon {...props} />}
      />
